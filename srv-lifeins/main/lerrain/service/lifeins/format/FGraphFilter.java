...
public class FGraphFilter implements FilterPlan {
    ...
    static {
        ...
        list.add(new Category("重疾保障", "max(THUNDER[0], THUNDER[1])", new int[]{0, 100000, 200000, 500000, 1000000},
                ...
                new Item("投保人重疾豁免", "'投保人罹患所重疾，免缴部分剩余保费'", "A_THUNDER_EXEMPT != null and A_THUNDER_EXEMPT > 0")
        ));
        list.add(new Category("轻症保障", "MILD", new int[]{0, 20000, 50000, 100000, 200000},
                new Item(null, "'罹患所保障的轻症疾病，保险公司给付轻症保险金最高'+format('%.2f', MILD/10000)+'万。'", "MILD != null and MILD > 0"),
                new Item("被保险人轻症豁免", "'被保险人罹患所保障的轻症疾病，免缴部分剩余保费'", "MILD_EXEMPT != null and MILD_EXEMPT > 0"),
                new Item("投保人轻症豁免", "'投保人罹患所保障的轻症疾病，免缴部分剩余保费'", "A_MILD_EXEMPT != null and A_MILD_EXEMPT > 0")
        ));
        list.add(new Category("身故保障", "max(ACCIDENT_DEATH, OTHER_DEATH)", new int[]{0, 100000, 500000, 1000000, 2000000},
                new Item("意外身故", "'被保人因意外伤害原因导致身故，保险公司给付将身故保险金，最高为'+format('%.2f', ACCIDENT_DEATH/10000)+'万。'", "ACCIDENT_DEATH != null and ACCIDENT_DEATH > 0"),
                new Item("非意外身故", "'若被保人因非意外伤害原因导致身故，保险公司给付身故保险金，最高为'+format('%.2f', OTHER_DEATH/10000)+'万。'", "OTHER_DEATH != null  and OTHER_DEATH > 0"),
                new Item("身故返还", "'被保人身故，保险公司给付身故保险金，为和谐健康之享主险已交保费'", "PAYBACK_DEATH > 0"),
                new Item("身故豁免", "'若投保人因意外或等待期（180天）后因非意外的原因导致身故，免缴部分剩余保费。'", "A_DEATH_EXEMPT != null  and  A_DEATH_EXEMPT > 0")
        ));
    }
