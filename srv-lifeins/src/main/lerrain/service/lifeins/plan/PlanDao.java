...
public class PlanDao
{
    ...
    {
        System.out.println("load plan: " + planId);

        return jdbc.queryForObject("select a.* from t_ins_plan a where a.PLAN_ID = ? and a.VALID is null", new Object[]{planId}, new RowMapper<Plan>()
        {
            @Override
